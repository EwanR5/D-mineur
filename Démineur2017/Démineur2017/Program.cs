...
namespace Démineur2017
{
    class Program
    {
        ...
        static void PoserDrapeaux(string[,] tableau, int a, int b, int drapeau)
        {
            if (tableau[a, b] == " * ")
            {
        ...
        static void RetirerDrapeaux(string[,] tableau, int a, int b, int drapeau)
        {
        ...
        static void RevelerTableau(string[,] tableau, int[,] plateau, int a, int b, int drapeau, int cases)
        {
            ...
            while (bombeMinee < 1)
            {
                ...
                {
                    PoserDrapeaux(tableau, a, b, drapeau);
                }
                else if (choix == "2")
                {
                    RetirerDrapeaux(tableau, a, b, drapeau);
                }
                else
                {
                    RevelerTableau(tableau, plateau, a, b, drapeau, cases);
